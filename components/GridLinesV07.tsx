...
function NativeLine({
  ...
  return <primitive object={object} renderOrder={40} />;
}
...
function GridCamera({
  ...
  }, [centerX, centerZ, distance, halfHeight, halfWidth]);
...
export default function GridLinesV07({ grids }: { grids: GridLine[] }) {
  ...
  return (
    <>
      <GridCamera centerX={centerX} centerZ={centerZ} span={span} />
