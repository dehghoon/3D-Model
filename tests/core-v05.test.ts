...
test("snow writeback preserves surface target and provenance", () => {
  const writeback = {
    ...
    runId: "R1",
    loadSources: [{ id: "LS1", calculator: "snow", calculatorVersion: "1.0", calculatorRunId: "R1" }],
    loads: [{ id: "LD1", type: "surface-pressure", loadCaseId: "LC1", surfaceId: "S1", pressure: { value: 2.5, unit: "kPa" }, provenance: { sourceId: "LS1", calculatorRunId: "R1" } }],
  };
...
test("snow writeback rejects lossy surface mapping", () => {
  const writeback = {
    modelSchemaVersion: "0.5", calculator: "snow", calculatorVersion: "1.0", runId: "R1", loadSources: [],
    loads: [{ id: "LD1", type: "surface-pressure", loadCaseId: "LC1", surfaceId: "S2", pressure: { value: 1, unit: "kPa" }, provenance: { sourceId: "LS1", calculatorRunId: "R1" } }],
  };
